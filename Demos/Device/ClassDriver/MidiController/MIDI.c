...
//        uint8_t MIDICommand = MIDICommand = MIDI_COMMAND_NOTE_ON;
...
void noteOn(uint8_t channel, uint8_t pitch) {
    uint8_t command = MIDI_COMMAND_NOTE_ON;
...
void EVENT_USB_Device_ConfigurationChanged(void)
{
	...
	LEDs_SetAllLEDs(ConfigSuccess ? LEDS_LED1 : LEDS_NO_LEDS);
}
